...
urlpatterns = [
    ...
    path('admin/view/auth/index', views.index_view),
    ...
    path('admin/view/auth/user_add_view', views.user_add_view),
    path('admin/view/auth/user_edit_view', views.user_edit_view),
    path('admin/view/auth/account_id/list', views.account_id_list_view),
    path('admin/view/auth/lid/list', views.lid_list_view),
    path('admin/view/auth/account_qr/list', views.account_qr_list_view),
    path('admin/view/auth/lqr/list', views.lqr_list_view),
    # line 分配记录
    path('admin/view/auth/aid_record/list', views.lines_aid_record_list_view),
    path('admin/view/auth/lid_record/list', views.lid_record_list_view),
    path('admin/view/auth/qr_record/list', views.lines_qr_record_list_view),
    path('admin/view/auth/lqr_record/list', views.lqr_record_list_view),
    # Whatsapp
    path('admin/view/auth/whatsapp/account_id/list', views.whatsapp_account_id_list_view),
    path('admin/view/auth/whatsapp/account_qr/list', views.whatsapp_account_qr_list_view),
    path('admin/view/auth/whatsapp/aid_record/list', views.whatsapp_aid_record_list_view),
    path('admin/view/auth/whatsapp/qr_record/list', views.whatsapp_qr_record_list_view),
    # whatsapp2
    path('admin/view/auth/whatsapp2/account_id/list', views.whatsapp2_account_id_list_view),
    path('admin/view/auth/whatsapp2/account_qr/list', views.whatsapp2_account_qr_list_view),
    path('admin/view/auth/whatsapp2/aid_record/list', views.whatsapp2_aid_record_list_view),
    path('admin/view/auth/whatsapp2/qr_record/list', views.whatsapp2_qr_record_list_view),

    # Whatsapp common
    path('admin/view/auth/wa/account_id/list', views.wa_account_id_list_view),
